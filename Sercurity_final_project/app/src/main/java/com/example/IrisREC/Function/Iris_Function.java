...
public class Iris_Function {
    public static Bitmap Hough_transform(Bitmap EyeInput){
        //Load OpenCV
...
//draw the found circles
        for (int x = 0; x < circles.cols(); x++) {
            ...
            Imgproc.circle(InputData, center, radius, new Scalar(255,0,0), 3, 8, 0 );
            int radius2 = (int) ((int)radius*2.4);
            Imgproc.circle(InputData, center, radius2, new Scalar(0,0,255), 3, 8, 0 );
...
//draw the found circles
            for (int x = 0; x < circles.cols(); x++) {
                ...
                int radius = (int) Math.round(c[2]);
                Imgproc.circle(InputData, center, radius, new Scalar(255,0,0), 3, 8, 0 );
                double radius2 = radius/2.4;
                Imgproc.circle(InputData, center, (int)radius2, new Scalar(0,0,255), 3, 8, 0 );
